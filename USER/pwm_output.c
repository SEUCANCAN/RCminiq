...
void pwm_start (void)
{ u16  ZHI=45000;     //在start初始化给下面的程序用
  u16  A=0;
		//TIM1->CCR2=47000;  // 转向通道
		TIM1->CCR3=47000;  
	  DelayNmS(10000);
	TIM1->CCR3=47000;
	//TIM1->CCR3=40000;
...
{ int  ZHI=(47000-(speed*20));  //改成20,之前是100
	int  A=0;
	if(ZHI>48000)  //reverse-limit  48000 before
	{
		ZHI=48000;
	}
	if(ZHI<43530)   //front-limit   40000 before
	{
		ZHI=43530;
	}
		TIM1->CCR3=ZHI;
